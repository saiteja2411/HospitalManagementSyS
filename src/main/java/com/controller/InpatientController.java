...
//        PrintWriter out = response.getWriter();
        ...
        int pPhoneNumber = Integer.parseInt(request.getParameter("pPhoneNumber"));
        String pAddress = request.getParameter("pAddress");
        int doctors = Integer.parseInt(request.getParameter("doctors"));
        ...
        inpatientDao.addInpatient(patientName,pAge,gender,pPhoneNumber,pAddress,doctors,admitDate,dischargeDate,roomNum);
    }
